...
@section('content')
        ...
        <ul class="slides">
            <li>
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                    ...
                    consequat.sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
                    veniam,
                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                    consequat. </p>
    ...
    <section class="about white-section pb-50 pt-100">
        <svg class="clouds" xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100"
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="section-title2">
                    ...
                    <p>Vous pouvez ajouter une touche de fantaisie à vos messages en achetant des éléments comme des
                        décorations, des nouvelles couleurs, polices d'écritures, ... et en débloquant des nouveaux
                        types de contenus.</p>
                </div>
            </div>
            <div class="row">
